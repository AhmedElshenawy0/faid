...
const relatedProducts = [
  {
    ...
    price: 12000,
    rating: 4.2,
    desc: "استمتع بأقصى درجات الاسترخاء والراحة مع كرسي الاسترخاء (الريكلينر) الفاخر هذا. مصمم بجلد شمواه عالي الجودة باللون البني الداكن الممزوج بنقوش كلاسيكية، ويتميز بمساند يد مرصعة بمسامير نحاسية تضفي لمسة من الأناقة والتراث. آلية الإمالة المدمجة تسمح لك بضبط وضعية الجلوس أو التمدد للحصول على دعم مثالي لجسمك وقضاء أوقات هادئة بعد يوم طويل",
  },
  {
    id: "3",
    title: "أريكة فاخرة",
